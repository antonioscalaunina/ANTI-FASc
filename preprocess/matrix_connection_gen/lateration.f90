...
implicit none
type mesh
       integer :: Nnodes,Ncells, nuc_mode, distance ! Number of Nodes and number of ameshents
       integer :: merc_zone
       ...
       real,allocatable,dimension(:) :: px,py,pz ! Coordinates of the nodes, area array for the ameshents and slip arra for the ameshents
