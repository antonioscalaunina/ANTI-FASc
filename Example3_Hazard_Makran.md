...
extract the needed scenario for PTF application (see Basili et al. 2021 and Selva et al. 2021 [bibliography](https://github.com/antonioscalaunina/ANTI-FASc/README.md)
...
To download the code you can either download the zip archive from the web-page of the [repository](https://github.com/antonioscalaunina/ANTI-FASc): 
